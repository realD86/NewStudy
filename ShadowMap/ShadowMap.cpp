...
void CALLBACK OnFrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
	...
	{	//PSM
		...
		D3DXMatrixMultiply(&matEyeView_EyeProjection_LightView, g_VCamera.GetViewMatrix(), g_VCamera.GetProjMatrix());	//ī�޶� �� * ī�޶� ����
		D3DXMatrixMultiply(&matEyeView_EyeProjection_LightView, &matEyeView_EyeProjection_LightView, &mLightView );	//ī�޶� �� * ī�޶� ����* ���� ��		
	...
	if( g_ShadowType == PERSPECTIVE )
	{	//mViewToLightProj���� �̹� ī�޶� view�� ���ԵǾ��ִ�
		D3DXMatrixInverse( &mViewToLightProj, NULL, &mViewToLightProj );
		D3DXMatrixMultiply(&mViewToLightProj, &mViewToLightProj, g_VCamera.GetProjMatrix());	//ī�޶� �� * ī�޶� ����
		D3DXMatrixMultiply(&mViewToLightProj, &mViewToLightProj, &mLightView );		//ī�޶� �� * ī�޶� ����* ���� ��		
